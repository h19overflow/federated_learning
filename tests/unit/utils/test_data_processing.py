...
class TestDataProcessor:
    ...
    def sample_config(self):
        ...
        return ExperimentConfig(sample_fraction=0.5, validation_split=0.2, seed=42)
    ...
    @patch("federated_pneumonia_detection.src.utils.data_processing.pd.read_csv")
    @patch("federated_pneumonia_detection.src.utils.data_processing.Path.exists")
    def test_load_metadata_csv_error(
        self,
        mock_exists,
        mock_read_csv,
        sample_constants,
    ...
    def test_sample_data_single_class(self, sample_constants):
        ...
        df = pd.DataFrame(
            {"patientId": ["001", "002", "003", "004"], "Target": [0, 0, 0, 0]},
        )
    ...
    def test_create_train_val_split_stratified(
        self,
        mock_split,
        sample_constants,
        sample_dataframe,
    ...
    @patch(
        "federated_pneumonia_detection.src.utils.data_processing.load_and_split_data",
    )
    def test_load_and_process_data_success(
        self,
        mock_load_and_split,
        sample_constants,
        sample_config,
        ...
        mock_load_and_split.return_value = (
    ...
    def test_load_and_process_data_error_handling(
        self,
        mock_load_and_split,
        sample_constants,
        sample_config,
