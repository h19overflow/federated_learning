...
2025-12-29 - Awaiting federated experiment completion
 python -m federated_pneumonia_detection.src.analysis.run_experiments --centralized-only --num-runs 2

  # Full run
  python -m federated_pneumonia_detection.src.analysis.run_experiments --centralized-only --num-runs 10
