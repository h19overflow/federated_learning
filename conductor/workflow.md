...
8. **Request Task Approval:**
   - **Action:** Present the completed work and test results to the user.
   - **Ask:** "Task '<Task Name>' is complete. Tests pass. Ready for approval?"
   - **PAUSE:** Await explicit user confirmation.
   - **Branch:**
     - *If approved:* Proceed to the next step.
     - *If rejected:* Return to Step 4 (Implement) or Step 3 (Write Tests) based on user feedback.
