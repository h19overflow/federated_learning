...
NOTE: SystemConstants and ExperimentConfig have been deprecated in favor of
ConfigManager. See federated_pneumonia_detection.config.config_manager for the
