    ...
    result_data = [
        [
            Paragraph(
                ...
                ParagraphStyle(
                    "Result", fontSize=16, textColor=result_color, alignment=TA_CENTER
                ),
            )
        ],
        [
...
def _add_images_section(
    ...
    if images_row:
        if len(images_row) == 2:
            img_table = Table(
                [[images_row[0][0], images_row[1][0]]], colWidths=[3 * inch, 3 * inch]
            )
            img_table.setStyle(
                TableStyle(
                    [
            ...
            caption_table = Table(
                [[images_row[0][1], images_row[1][1]]], colWidths=[3 * inch, 3 * inch]
            )
...
def _add_footer(story: list, model_version: str) -> None:
    ...
    story.append(
        Paragraph(
            ...
            ParagraphStyle(
                "Footer", fontSize=7, textColor=colors.gray, alignment=TA_CENTER
            ),
        )
    )
