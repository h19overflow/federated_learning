"""Metric extraction strategies for different training modes.

Provides abstract base class and concrete implementations for extracting
metrics from centralized and federated training runs.
"""
