...
class ExperimentOrchestrator:
    ...
    def __init__(
        ...
        self.experiment_dir = os.path.join(
            base_output_dir, f"experiment_{self.timestamp}"
        )
    ...
    def run_centralized(
        self, source_path: str, experiment_name: str = "centralized_training"
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"status": "failed", "error": str(e), "output_dir": centralized_dir}

    def run_federated(
        self, source_path: str, experiment_name: str = "federated_training"
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"status": "failed", "error": str(e), "output_dir": federated_dir}
    ...
    def _generate_comparison(
        self, centralized_results: Dict[str, Any], federated_results: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        ...
        if (
            centralized_results["status"] == "success"
            and federated_results["status"] == "success"
        ):
...
def run_quick_comparison(
    source_path: str, config_path: Optional[str] = None, partition_strategy: str = "iid"
) -> Dict[str, Any]:
    """
    ...
    orchestrator = ExperimentOrchestrator(
        config_path=config_path, partition_strategy=partition_strategy
    )
