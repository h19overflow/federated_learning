...
class SystemConfig(BaseModel):
    ...
    img_size: Optional[List[int]] = Field(None, description="Image size as [height, width]")
    ...
    sample_fraction: Optional[float] = Field(None, description="Fraction of data to sample")
    validation_split: Optional[float] = Field(None, description="Validation split ratio")
...
class PathsConfig(BaseModel):
    ...
    main_images_folder: Optional[str] = Field(None, description="Main images folder name")
...
class ExperimentConfig(BaseModel):
    ...
    freeze_backbone: Optional[bool] = Field(None, description="Whether to freeze backbone")
    dropout_rate: Optional[float] = Field(None, description="Dropout rate")
    fine_tune_layers_count: Optional[int] = Field(None, description="Number of layers to fine-tune")
    ...
    # System parameters
    device: Optional[str] = Field(None, description="Device to use (cuda, cpu, mps, auto)")
    ...
    use_imagenet_norm: Optional[bool] = Field(None, description="Use ImageNet normalization")
    augmentation_strength: Optional[float] = Field(None, description="Augmentation strength")
    use_custom_preprocessing: Optional[bool] = Field(None, description="Use custom preprocessing")
    validate_images_on_init: Optional[bool] = Field(None, description="Validate images on init")
    pin_memory: Optional[bool] = Field(None, description="Pin memory for GPU")
    persistent_workers: Optional[bool] = Field(None, description="Use persistent workers")
    ...
    adaptive_histogram: Optional[bool] = Field(None, description="Apply adaptive histogram")
    edge_enhancement: Optional[bool] = Field(None, description="Apply edge enhancement")
    lower_percentile: Optional[float] = Field(None, description="Lower percentile for preprocessing")
    upper_percentile: Optional[float] = Field(None, description="Upper percentile for preprocessing")
    clip_limit: Optional[float] = Field(None, description="Clip limit for preprocessing")
    edge_strength: Optional[float] = Field(None, description="Edge strength for preprocessing")
