              ...
              <motion.div variants={cardHoverVariants}>
                <Card className="p-6 border-[hsl(210,15%,92%)] transition-shadow hover:shadow-xl">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm text-[hsl(215,15%,50%)]">{card.label}</p>
                      <motion.p
          ...
          <Card className="p-6 transition-shadow hover:shadow-xl">
            ...
            <ResponsiveContainer width="100%" height={300}>
              ...
              >
                ...
                />
                <Bar dataKey="duration" radius={[8, 8, 0, 0]} animationDuration={800}>
                  {[
        ...
        <motion.div variants={cardHoverVariants}>
          <Card className="p-6 transition-shadow hover:shadow-xl">
            ...
            <Table>
              ...
              <TableBody>
                {[
                  { label: 'Precision', cent: centralizedData.avg_precision, fed: federatedData.avg_precision },
                  { label: 'Recall', cent: centralizedData.avg_recall, fed: federatedData.avg_recall },
                  { label: 'F1 Score', cent: centralizedData.avg_f1, fed: federatedData.avg_f1 },
                  { label: 'Avg Duration', cent: centralizedData.avg_duration_minutes, fed: federatedData.avg_duration_minutes, isDuration: true },
                ].map((row, i) => (
                  <motion.tr
                    key={row.label}
                    custom={i}
                  ...
                  >
                    ...
                    <TableCell className="text-center">
                      {row.isDuration ? formatDuration(row.cent) : formatPercentage(row.cent)}
                    </TableCell>
                    <TableCell className="text-center">
                      {row.isDuration ? formatDuration(row.fed) : formatPercentage(row.fed)}
                    </TableCell>
                    <TableCell className="text-center">
                      {(() => {
                        ...
                        return (
                          ...
                          >
                            <Badge className={
                              ...
                              {winner === 'centralized' ? 'Cent.' : 'Fed.'} <ArrowUp className="w-3 h-3 ml-1 inline" />
                            </Badge>
                          </motion.div>
                        );
                      })()}
          ...
          <Card className="p-6 transition-shadow hover:shadow-xl">
            ...
            <ResponsiveContainer width="100%" height={350}>
              <BarChart data={chartData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                ...
                />
                <Legend />
                <Bar dataKey="Centralized" fill="hsl(172, 63%, 28%)" radius={[8, 8, 0, 0]} animationDuration={800} />
                <Bar dataKey="Federated" fill="hsl(210, 60%, 50%)" radius={[8, 8, 0, 0]} animationDuration={800} />
              </BarChart>
            </ResponsiveContainer>
          </Card>
        </motion.div>
