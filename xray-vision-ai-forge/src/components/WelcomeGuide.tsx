  ...
  const icons = {
    ...
    configure: (
      <svg className="w-12 h-12" viewBox="0 0 48 48" fill="none">
        ...
        />
        <path
          d="M24 12v6m0 12v6m-12-12h6m12 0h6"
          stroke="hsl(172 63% 22%)"
          strokeWidth="2"
          strokeLinecap="round"
        />
    ...
    analyze: (
      <svg className="w-12 h-12" viewBox="0 0 48 48" fill="none">
        ...
        />
        <path
          d="M10 18h8M10 24h8M10 30h5"
          stroke="hsl(172 50% 50%)"
          strokeWidth="1.5"
          strokeLinecap="round"
        />
        <path
          d="M30 18h8M30 24h8M30 30h5"
          stroke="hsl(172 50% 50%)"
          strokeWidth="1.5"
          strokeLinecap="round"
        />
        <path
          d="M22 20l2 2 2-2M22 28l2-2 2 2"
      ...
      content: (
        <div className="space-y-6">
          <p className="text-[hsl(215_15%_40%)] leading-relaxed text-lg">
            Train deep learning models for pneumonia detection from chest
            X-rays. Choose between{" "}
            ...
            {[
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="font-medium text-[hsl(172_43%_20%)]">
                      {item.label}
                    </span>
                    <span className="text-[hsl(215_15%_50%)] text-sm block">
                      {item.sublabel}
                    </span>
                  </div>
                </div>
        ...
        <div className="space-y-6">
          <div className="relative group">
            ...
            <div className="relative bg-white/80 backdrop-blur-sm rounded-[1.5rem] p-6 border border-[hsl(172_30%_88%)]">
              <h4 className="font-semibold text-[hsl(172_43%_15%)] text-lg mb-4">
                Dataset Format
              </h4>
              <p className="text-[hsl(215_15%_45%)] mb-4">
              ...
              <ul className="space-y-3">
                {[
                  {
                    title: "Images folder",
                    desc: "X-ray images organized by class",
                  },
                  {
                    title: "Metadata CSV",
                    desc: "Image labels and information",
                  },
                ].map((item, i) => (
          ...
          <div className="p-4 rounded-xl bg-[hsl(35_60%_96%)] border border-[hsl(35_50%_85%)]">
            <p className="text-sm text-[hsl(35_50%_30%)]">
              ...
              Configure the train/validation split to control how much data is
        ...
        <div className="space-y-6">
            ...
            {[
              ...
              <div key={i} className="relative group">
                ...
                <div className="relative h-full bg-white/80 backdrop-blur-sm rounded-2xl p-5 border border-[hsl(172_30%_88%)]">
                  ...
                  <h4 className="font-semibold text-[hsl(172_43%_15%)] mb-2">
                    {mode.title}
                  </h4>
                  <p className="text-sm text-[hsl(215_15%_50%)] mb-3">
                    {mode.desc}
                  </p>
                  <ul className="space-y-1.5">
                    {mode.benefits.map((b, j) => (
                      <li
                        key={j}
                        className="flex items-center gap-2 text-sm text-[hsl(152_60%_30%)]"
                      >
                        <svg
          ...
          <div className="p-4 rounded-xl bg-[hsl(172_40%_96%)] border border-[hsl(172_35%_88%)]">
            <p className="text-sm text-[hsl(172_35%_30%)]">
              <span className="font-semibold text-[hsl(172_45%_25%)]">
                New to ML?
              </span>{" "}
              Start with the default values — they're optimized for most use
              cases.
            </p>
          </div>
        </div>
      ...
      content: (
        <div className="space-y-6">
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-br from-[hsl(172_50%_92%)] to-[hsl(168_40%_87%)] rounded-[1.5rem] blur-xl opacity-40" />
            <div className="relative bg-white/80 backdrop-blur-sm rounded-[1.5rem] p-6 border border-[hsl(172_30%_88%)]">
              <h4 className="font-semibold text-[hsl(172_43%_15%)] text-lg mb-5">
              ...
              <div className="space-y-4">
                {[
                  {
                    title: "Live Metrics",
                    desc: "Track loss, accuracy, and other metrics as they update",
                  },
                  {
                    title: "Progress Bars",
                    desc: "See epoch and round progress at a glance",
                  },
                  {
                    title: "Status Messages",
                    desc: "Get detailed training updates and notifications",
                  },
                ].map((feature, i) => (
                  <div
                    key={i}
          ...
          <div className="p-4 rounded-xl bg-[hsl(172_40%_96%)] border border-[hsl(172_35%_88%)]">
            <p className="text-sm text-[hsl(172_35%_30%)]">
              ...
              Training can take a while. Feel free to minimize — we'll keep you
              updated!
            </p>
          </div>
        </div>
            ...
            <div className="relative bg-white/80 backdrop-blur-sm rounded-[1.5rem] p-6 border border-[hsl(172_30%_88%)]">
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                {[
                  ...
                  <div
                    key={i}
                    className="text-center p-4 rounded-xl bg-white/60 border border-[hsl(172_25%_90%)]"
                  >
                    <div
                    ...
                    <div className="text-xs text-[hsl(215_15%_50%)] mt-1">
                      {metric.label}
                    </div>
                  </div>
                ))}
                ...
                {[
                  {
                    ...
                    desc: "Accuracy, precision, recall, F1-score, AUROC",
                  },
                  {
                    title: "Training Curves",
                    desc: "Visualize loss and accuracy over time",
                  },
                  {
                    title: "Confusion Matrix",
                    desc: "See detailed classification patterns",
                  },
                ].map((item, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-lg bg-[hsl(152_50%_94%)] flex items-center justify-center flex-shrink-0 mt-0.5">
                      <svg
                        className="w-3 h-3 text-[hsl(152_60%_35%)]"
                        viewBox="0 0 12 12"
                        fill="none"
                      >
                        <path
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div>
                ...
                <span className="text-white/80 text-sm">
                  Click "Get Started" to begin your first experiment!
                </span>
              </div>
            </div>
          </div>
