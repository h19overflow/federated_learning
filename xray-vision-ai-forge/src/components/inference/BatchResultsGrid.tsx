    ...
    <div className="space-y-6">
       ...
       <div className="flex flex-col sm:flex-row gap-4 p-5 rounded-2xl bg-white/90 backdrop-blur-sm border border-[hsl(172_30%_88%)] shadow-md">
         ...
         <div className="flex-1">
           <p className="text-xs font-semibold text-[hsl(215_15%_50%)] uppercase tracking-wide mb-2">
             Filter Results
           </p>
         ...
         <div className="flex flex-col sm:items-end gap-2">
           <p className="text-xs font-semibold text-[hsl(215_15%_50%)] uppercase tracking-wide">
             Sort By
           </p>
           <Select
             value={sortBy}
           ...
           >
             <SelectTrigger className="w-full sm:w-[160px] rounded-xl border-[hsl(172_30%_85%)]">
               <SelectValue />
             </SelectTrigger>
             <SelectContent>
       ...
       <div className="flex items-center justify-between px-2">
         <p className="text-sm font-medium text-[hsl(172_43%_20%)]">
           Showing <span className="font-bold">{sortedResults.length}</span> result
           ...
           {sortedResults.map((result, index) => {
             ...
             return (
               ...
               >
                 ...
                 <div className="absolute top-2 right-2 px-2 py-1 rounded-lg bg-white/95 backdrop-blur-sm text-xs font-medium text-[hsl(172_43%_20%)] opacity-0 group-hover:opacity-100 transition-opacity duration-200 shadow-md">
