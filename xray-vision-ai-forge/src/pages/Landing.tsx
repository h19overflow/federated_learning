  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden">
      ...
      <main ref={mainRef} className="flex-1 overflow-y-auto bg-hero-gradient">
        ...
        <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-6 overflow-hidden">
          ...
          <div className="absolute right-[-5%] top-1/2 -translate-y-1/2 w-[50%] h-[80%] pointer-events-none hidden lg:block">
            <div
              ...
              style={{
                maskImage:
                  "radial-gradient(ellipse 80% 70% at 70% 50%, rgba(0,0,0,0.7) 0%, rgba(0,0,0,0.4) 50%, transparent 80%)",
                WebkitMaskImage:
                  "radial-gradient(ellipse 80% 70% at 70% 50%, rgba(0,0,0,0.7) 0%, rgba(0,0,0,0.4) 50%, transparent 80%)",
              }}
            >
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            ...
            <h1 className="hero-headline text-5xl md:text-7xl font-semibold tracking-tight text-[hsl(172_43%_15%)] mb-6">
              ...
              <br />
              <span className="word inline-block text-[hsl(172_63%_28%)]">
                Refined.
              </span>
            </h1>
            ...
            <p className="hero-subheadline text-xl md:text-2xl text-[hsl(215_15%_45%)] font-light max-w-2xl mx-auto mb-12 leading-relaxed">
              ...
              <span className="font-medium text-[hsl(172_43%_25%)]">
                {" "}
                Centralized{" "}
              </span>
              or
              ...
              {[
                {
                  ...
                  description:
                    "Pre-trained ResNet50 V2 architecture, fine-tuned for medical imaging with exceptional accuracy.",
                },
                {
                  icon: (
                    <Shield className="w-10 h-10 text-[hsl(172_63%_22%)]" />
                  ),
                  title: "Privacy-Preserving",
                  description:
                    "Federated learning ensures patient data remains private and secure, never leaving local devices.",
                },
                {
                  icon: (
                    <Activity className="w-10 h-10 text-[hsl(172_63%_22%)]" />
                  ),
                  title: "Real-Time Monitoring",
                  description:
                    "Watch training metrics and performance live with elegant, interactive visualizations.",
                },
              ].map((feature, index) => (
                <div
                  key={index}
        ...
        <section
          ref={comparisonRef}
          className="comparison-section py-32 px-6 bg-trust-gradient relative overflow-hidden"
        >
                ...
                <div className="relative bg-white/90 backdrop-blur-sm rounded-[2rem] p-10 border border-[hsl(172_30%_88%)] shadow-lg hover:shadow-2xl transition-all duration-500">
                  ...
                  <div className="flex items-start justify-between mb-8">
                    ...
                    <div className="p-3 rounded-2xl bg-[hsl(172_40%_94%)]">
                      <svg
                        className="w-8 h-8 text-[hsl(172_50%_35%)]"
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="1.5"
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2">
                      {[
                        ...
                        <li
                          key={i}
                          className="flex items-center gap-3 text-[hsl(215_15%_40%)]"
                        >
                  ...
                  <div className="mt-6 pt-6 border-t border-[hsl(172_20%_92%)] space-y-4">
                    ...
                    <ul className="space-y-2">
                      {[
                        ...
                        <li
                          key={i}
                          className="flex items-center gap-3 text-[hsl(215_15%_50%)]"
                        >
                  ...
                  <div className="federated-diagram relative h-64 mb-8 rounded-2xl bg-gradient-to-br from-[hsl(172_30%_97%)] to-[hsl(168_40%_93%)] overflow-hidden">
                    ...
                    >
                      ...
                      {[0, 1, 2].map((i) => (
                        <g
                          key={i}
                          transform={`translate(${50 + i * 100}, 155)`}
                        ...
                        >
                          ...
                          <rect
                            ...
                            rx="6"
                            fill="white"
                            stroke="hsl(172 40% 75%)"
                            strokeWidth="2"
                          />
                          {/* Database icon */}
                          <path
                            d="M-10,-10 L10,-10 M-10,-3 L10,-3 M-10,4 L10,4"
                          ...
                          <g transform="translate(12, -12)">
                            ...
                            {/* Lock icon */}
                            <path
                              d="M-2,0 L-2,-2 A2,2 0 0,1 2,-2 L2,0"
                              stroke="white"
                              strokeWidth="1.2"
                              fill="none"
                              strokeLinecap="round"
                ...
                <table className="w-full">
                  <thead>
                    <tr className="comparison-table-row border-b border-[hsl(210_15%_92%)]">
                      <th className="py-4 px-6 text-left text-sm font-semibold text-[hsl(172_43%_20%)]">
                        Feature
                      </th>
                      <th className="py-4 px-6 text-center text-sm font-semibold text-[hsl(210_60%_40%)]">
                        Centralized
                      </th>
                      <th className="py-4 px-6 text-center text-sm font-semibold text-[hsl(172_63%_28%)]">
                        Federated
                      </th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-[hsl(210_15%_95%)]">
                    {[
                      ...
                      },
                      {
                        ...
                        centralized: { text: "Fast", status: "success" },
                        federated: { text: "Slower", status: "warning" },
                      },
                      {
                        feature: "Setup Complexity",
                        centralized: { text: "Simple", status: "success" },
                        federated: { text: "Complex", status: "warning" },
                      },
                      {
                        feature: "Compliance",
                        centralized: {
                          text: "Requires safeguards",
                          status: "warning",
                        },
                        federated: {
                          text: "Built-in privacy",
                          status: "success",
                        },
                      },
                      {
                        feature: "Model Quality",
                        centralized: { text: "Excellent", status: "success" },
                        federated: { text: "Comparable", status: "success" },
                      },
                      {
                        feature: "Scalability",
                        centralized: {
                          text: "Limited by server",
                          status: "warning",
                        },
                        federated: {
                      ...
                      <tr
                        key={index}
                        className="comparison-table-row hover:bg-[hsl(168_25%_98%)] transition-colors"
                      >
                        <td className="py-4 px-6 text-sm font-medium text-[hsl(172_43%_20%)]">
                          {row.feature}
                        </td>
        ...
        <section className="how-it-works-section py-32 bg-white relative overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div
              ...
              style={{
                maskImage:
                  "radial-gradient(circle at center, rgba(0,0,0,1) 0%, rgba(0,0,0,0.5) 40%, transparent 70%)",
                WebkitMaskImage:
                  "radial-gradient(circle at center, rgba(0,0,0,1) 0%, rgba(0,0,0,0.5) 40%, transparent 70%)",
              }}
            >
          ...
          <div className="relative z-10">
            <div className="how-it-works-title text-center mb-16 px-6">
              ...
              <p className="text-xl text-[hsl(215_15%_45%)] max-w-2xl mx-auto">
                From data upload to model comparison — a streamlined ML
                pipeline.
              </p>
            </div>
                ...
                {[
                  {
                    ...
                    description:
                      "Upload chest X-ray images with NORMAL/PNEUMONIA folder structure.",
                    icon: (
                  ...
                  },
                  {
                    ...
                    description:
                      "Set hyperparameters and choose Centralized or Federated mode.",
                    icon: (
                      <svg className="w-8 h-8" viewBox="0 0 40 40" fill="none">
                        <circle
                          cx="20"
                  ...
                  },
                  {
                    ...
                    title: "Train Model",
                    description:
                      "PyTorch Lightning training with real-time metrics via WebSocket.",
                    icon: (
                      <svg className="w-8 h-8" viewBox="0 0 40 40" fill="none">
                        <path
                          d="M5 30l8-8 6 6 16-16"
                          stroke="currentColor"
                          strokeWidth="2.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                  ...
                  },
                  {
                    ...
                    description:
                      "Analyze Centralized vs Federated performance with detailed metrics.",
                    icon: (
                      <svg className="w-8 h-8" viewBox="0 0 40 40" fill="none">
                        <rect
                          x="5"
                        ...
                        />
                        <path
                          d="M9 14h5M9 19h5M9 24h3"
                          stroke="currentColor"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                        />
                        <path
                          d="M26 14h5M26 19h5M26 24h3"
                          stroke="currentColor"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                        />
                        <path
                          d="M18 16l2 2 2-2M18 24l2-2 2 2"
                          stroke="currentColor"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                  ...
                  <div key={index} className="step-card relative group">
                    ...
                    {index < 3 && (
                      <div className="hidden lg:block absolute top-1/2 -right-3 transform -translate-y-1/2 z-10">
                        <svg
                          className="w-5 h-5 text-[hsl(172_40%_75%)]"
                          viewBox="0 0 24 24"
                          fill="none"
                        >
                          <path
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div
                ...
                style={{
                  maskImage:
                    "radial-gradient(ellipse 60% 80% at 50% 50%, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.3) 50%, transparent 80%)",
                  WebkitMaskImage:
                    "radial-gradient(ellipse 60% 80% at 50% 50%, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.3) 50%, transparent 80%)",
                }}
              >
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            <div className="cta-content">
              ...
              <p className="text-xl text-white/80 mb-12 max-w-xl mx-auto">
                Start detecting pneumonia with state-of-the-art machine
                learning, powered by privacy-preserving technology.
              </p>
            </div>
