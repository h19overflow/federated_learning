...
class FederatedExperimentRunner:
    ...
    def _invoke_federated_training(
        ...
        federated_dir = Path("federated_pneumonia_detection/src/control/federated_new_version")

        cmd = [
            "powershell",
            "-ExecutionPolicy", "Bypass",
            "-File", str(federated_dir / "rf.ps1"),
        ]
    ...
    def _find_results_file(self) -> Optional[Path]:
